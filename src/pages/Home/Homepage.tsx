      ...
      <div className="homepage pt-20 px-6">
        <div className="flex flex-col">
          ...
          <p className="text-justify text-white sm:w-10/12 sm:mx-auto  md:w-7/12 md:mx-auto lg:w-5/12 lg:mx-auto xl:w-4/12 xl:mx-auto py-2 p-2">
            Bienvenue sur Manag'Event, notre application dédiée à la célébration
            de la diversité des événements et des talents bénévoles. Chacune de
            ces occasions, qu'elles soient culturelles, caritatives, sportives
            ou artistiques, est une opportunité unique de rassembler nos forces
            et nos passions pour créer des expériences mémorables et uniques.
          </p>
        </div>
